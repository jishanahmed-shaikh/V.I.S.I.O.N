...
def main():
    ...
    weights_path = r'C:\Users\kaise\OneDrive\Desktop\VISION\RESR\weights\RealESRGAN_x4plus.pth'
    # Model configuration for RealESRGAN_x4plus
    model = RRDBNet(num_in_ch=3, num_out_ch=3, num_feat=64, num_block=23, num_grow_ch=32, scale=4)  #Residual in Residual Dense Block
    netscale = 4
